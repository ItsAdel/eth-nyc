...
export function BattleCard() {
  ...
  if (
    !chainId ||
    (chainId !== arbitrumSepolia.id && chainId !== optimismSepolia.id)
  ) {
    return (
      <div className="rounded-2xl bg-gray-800/50 border border-gray-700 p-8 text-center">
        <p className="text-gray-300">
          Please connect to Arbitrum Sepolia or Optimism Sepolia to battle
        </p>
      </div>
    );
  }
      ...
      <div className="space-y-4 mb-6">
        <div>
          ...
          <input
            ...
            className="w-full px-4 py-3 rounded-lg bg-gray-800 border border-gray-600 text-white placeholder-gray-400 focus:border-purple-500 focus:ring-2 focus:ring-purple-500/50 focus:outline-none disabled:opacity-50 disabled:cursor-not-allowed"
        ...
        <div>
          ...
          <select
            ...
            className="w-full px-4 py-3 rounded-lg bg-gray-800 border border-gray-600 text-white focus:border-purple-500 focus:ring-2 focus:ring-purple-500/50 focus:outline-none disabled:opacity-50 disabled:cursor-not-allowed"
            disabled={status !== "idle"}
          >
        ...
        <div className="mb-6 p-4 rounded-lg bg-blue-500/20 border border-blue-500/30">
          <div className="flex items-center gap-3">
            ...
            <p className="font-medium">
              ...
              {status === "complete" &&
                "✅ Battle complete! Rewards incoming..."}
            </p>
          </div>
        </div>
      )}
