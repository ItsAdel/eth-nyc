    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-purple-900 to-gray-900">
      ...
      <main className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          <h2 className="text-5xl font-bold mb-4">Cross-Chain Gaming</h2>
          <p className="text-xl text-gray-300">Battle goblins, earn rewards, and manage resources across multiple chains</p>
        </div>
        ...
        <div className="grid gap-6 md:grid-cols-3 mb-12">
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <p className="text-gray-300">Send your NFT to battle goblins across chains and earn Energy tokens</p>
            </div>
          </Link>
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <p className="text-gray-300">Burn Energy tokens to get Wood and Ore resources</p>
            </div>
          </Link>
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <p className="text-gray-300">Transfer tokens and NFTs across supported chains</p>
            </div>
          </Link>
        </div>
        ...
        <div className="mt-12 rounded-2xl bg-gray-800/50 border border-gray-700 p-8">
          <h3 className="text-2xl font-bold mb-6 text-center">Supported Chains</h3>
