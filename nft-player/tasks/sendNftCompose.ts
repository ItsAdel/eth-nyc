...
task('send-nft-compose', 'Sends an NFT to trigger a battle on the destination chain')
    ...
    .setAction(async (taskArgs, { ethers, deployments }) => {
        ...
        const composeMsg = ethers.utils.defaultAbiCoder.encode(['uint256'], [tokenId])
        ...
        console.log(`⚔️  Token #${tokenId} will battle a goblin on destination chain`)
        console.log(`🎲 50% chance of victory - good luck!`)
